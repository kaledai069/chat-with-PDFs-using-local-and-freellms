...
# typical initialization, based on how the application logic in streamlit flows
...
if st.session_state['local_llm']:
    ...
    # utilizing groq api (glitch) for mixtral 
    llm_model = ChatGroq(temperature = 0, model_name = "mixtral-8x7b-32768")
